  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-slate-400">Access your school dashboard</p>
      </div>
            ...
            <input
              ...
              className={`w-full pl-10 glass-input ${
                formik.touched.email && formik.errors.email
                  ? 'border-red-500/50 focus:ring-red-550/50'
                  : ''
              }`}
      ...
      <div className="text-center text-sm text-slate-400 mt-6">
        ...
        <Link to="/register" className="font-semibold text-sky-400 hover:text-sky-350 transition-colors">
          Create an Account
        </Link>
      </div>
    </div>
